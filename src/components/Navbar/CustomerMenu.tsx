...
export const icons = {
  ...
  search: (
    <SearchIcon className="text-secondary" fill="currentColor" size={30} />
  ),
    ...
    <Dropdown>
      ...
      >
        ...
        <DropdownItem
          ...
          href="/customers/list"
          key="sorgulama"
          description="Eklenmiş müşterilerinizi sorgulamak ve yeni müşteri eklemek için tıklayınız."
          startContent={icons.search}
        >
          Müşteri Ekleme/Sorgulama
        </DropdownItem>
      </DropdownMenu>
    </Dropdown>
  );
